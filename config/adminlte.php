...
return [
    ...
    */
    ...
    'logo' => '<b>Gastos</b>Gloria',
    'logo_img' => 'vendor/adminlte/dist/img/CalculadoraPNG.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/CalculadoraPNG.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu'  => [
                [
                    'text'=>'Ver gastos personales',
                    'url'=>'compromisos_pago',
                    'icon'=>'fas fa-glasses fa-lg'
                ],
                [
                    'text'=>'Registrar gasto personal',
                    'url'=>'compromisos_pago/create',
        ...
        [
            ...
            'icon' => 'fas fa-user-astronaut fa-lg',
            'submenu'  => [
                [
                    'text'=>'Ver gastos personales',
                    'url'=>'gastospersonales',
                    'icon'=>'fas fa-glasses fa-lg'
                ],
                [
                    'text'=>'Registrar gasto personal',
                    'url'=>'gastospersonales/create',
                    'icon'=>'fas fa-plus-square fa-lg'
                ],
            ],
        ],
        ...
        [
            ...
            'submenu'  => [
                [
                    'text'=>'Ver gastos oficina',
                    'url'=>'gastosoficina',
                    'icon'=>'fas fa-glasses fa-lg'
                ],
                [
                    'text'=>'Registrar gasto oficina',
                    'url'=>'gastosoficina/create',
                    'icon'=>'fas fa-plus-square fa-lg'
                ],
            ],
        ...
        [
            ...
            'submenu'  => [
                [
                    'text'=>'Ver gastos Clubes',
                    'url'=>'gastosclubes',
                    'icon'=>'fas fa-glasses fa-lg'
                ],
                [
                    'text'=>'Registrar gasto clubes',
                    'url'=>'gastosclubes/create',
                    'icon'=>'fas fa-plus-square fa-lg'
                ],
            ],
        ],
