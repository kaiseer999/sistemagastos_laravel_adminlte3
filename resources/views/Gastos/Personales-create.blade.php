...
@section('title', 'Crear gastos personales')
@section('content_header')

    <h1 class="m-0 text-dark">Registrar un nuevo gasto personal</h1>
@stop

@section('content')

<form action="{{url ('/gastospersonales')}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="card">
        <div class="card-header" style="background-color: #0202f5; color: #ffffff;"><center><b>CREAR</b></center></div>
        <div class="card-body">
            <div class="row">
