...
@section('title', 'Crear gastos clubes')

@section('content_header')
    <h1 class="m-0 text-dark">Registrar una nuevo gasto de los clubes</h1>
@stop

@section('content')
<form action="{{url ('/gastosclubes')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-header" style="background-color: #f70254; color: #ffffff;"><center><b>CREAR</b></center></div>
        <div class="card-body">
            <div class="row">
